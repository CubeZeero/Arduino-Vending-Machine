...
void hitset(){
  if(hitnum == 1){
      tft.drawRect(65,40,50,70,RED);
    }
    else if(hitnum == 2){
      tft.drawRect(65,115,50,70,RED);
    }
    else if(hitnum == 3){
      tft.drawRect(120,115,50,70,RED);
    }
    else if(hitnum == 4){
      tft.drawRect(120,40,50,70,RED);
    }
}
...
void roulette(){
  ...
  int i,lpc = 0,lpcbox = 0,delay_lpc = 1,lpc_now = 0;
  int looplimit = random(10,21);

  hitnum = random(1,5);

  if(hitnum == 1){
      tft.fillRect(65,40,50,70,RED);
    }
    else if(hitnum == 2){
      tft.fillRect(65,115,50,70,RED);
    }
    else if(hitnum == 3){
      tft.fillRect(120,115,50,70,RED);
    }
    else if(hitnum == 4){
      tft.fillRect(120,40,50,70,RED);
    }
  
  tft.drawRect(65,40,50,70,WHITE);
  tft.drawRect(120,40,50,70,WHITE);
  tft.drawRect(65,115,50,70,WHITE);
  tft.drawRect(120,115,50,70,WHITE);
  
  tft.setCursor(43,225);
  tft.setTextColor(GREEN);
  tft.setTextSize(2);
  tft.print("RED IS HIT !!");
  tft.setCursor(76,255);
  tft.setTextSize(1);
  tft.print("Let's Roulette!");
  ...
  for(i = 0; i <= looplimit; i++){
    ...
    if(lpcbox == 1){
      tft.fillRect(120,40,50,70,BLACK);
      tft.drawRect(120,40,50,70,WHITE);
      tft.fillRect(65,40,50,70,GREEN);
      hitset();
      
      lpc_now = 1;
    }
    else if(lpcbox == 2){
      tft.fillRect(65,40,50,70,BLACK);
      tft.drawRect(65,40,50,70,WHITE);
      tft.fillRect(65,115,50,70,GREEN);
      hitset();

      lpc_now = 2;
    }
    else if(lpcbox == 3){
      tft.fillRect(65,115,50,70,BLACK);
      tft.drawRect(65,115,50,70,WHITE);
      tft.fillRect(120,115,50,70,GREEN);
      hitset();

      lpc_now = 3;
    }
    else if(lpcbox == 4){
      tft.fillRect(120,115,50,70,BLACK);
      tft.drawRect(120,115,50,70,WHITE);
      tft.fillRect(120,40,50,70,GREEN);
      hitset();
  ...
  tft.fillRect(40,220,170,170,BLACK);
  ...
  if (hitnum == lpc_now){ 
    ...
    tft.setTextSize(3);
    tft.print("WIN!!");
    tft.setCursor(39,270);
    tft.setTextSize(1);
    tft.print("You can choose another one!");
    ...
    tft.setTextSize(3);
    tft.print("LOSE...");
    tft.setCursor(79,270);
    tft.setTextSize(1);
    tft.print("Visit Again!");
...
void setup() {
  ...
  guard_servo.attach(5);
  
  refund_servo.write(20);
  guard_servo.write(90);
...
void loop(){
  ...
  if (cancel_Sw == 0){
    ...
    clear_LCD();
    refund_servo.write(140);
    guard_servo.write(30);

    thankyou();

    pwm.writeMicroseconds(button_num-1, 100);
    delay(1590);
